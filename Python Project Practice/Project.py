...
class Sorting_App:
    def __init__(self,root):
        ...
        self.logo_icon=PhotoImage(file="logo1.png")
        ...
        #-------Section3-------
        #-----All Image Icon------
        self.image_icon=PhotoImage(file="imagelogo.png")
        self.imagelogo=self.image_icon.subsample(7,7)

        self.audio_icon=PhotoImage(file="oaudiologo.png")
        self.audiologo=self.audio_icon.subsample(3,3)

        self.video_icon=PhotoImage(file="ovideologo.png")
        self.videologo=self.video_icon.subsample(4,4)

        self.doc_icon=PhotoImage(file="doclogo.png")
        self.doclogo=self.doc_icon.subsample(3,3)

        self.other_icon=PhotoImage(file="otherlogo.png")
