...
class Sorting_App:
    def __init__(self,root):
        ...
        self.btn_clear=Button(self.root,text="CLEAR",font=("times new roman",15,"bold"),bd=3,relief=RAISED,bg="#607d8b",fg="white",activebackground="#262626",activeforeground="white",cursor="hand2") 
        self.btn_clear.place(x=950,y=590,height=30,width=120)
        self.btn_start=Button(self.root,command=self.start_function,text="START",font=("times new roman",15,"bold"),bd=3,relief=RAISED,bg="orange",fg="white",activebackground="#ff5722",activeforeground="white",cursor="hand2")
