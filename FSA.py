...
class Sorting_App:
    def __init__(self,root):
        ...
        self.logo_icon=PhotoImage(file=os.path.join("Images","logo1.png"))
        ...
        #-------Section3-------
        #-----All Image Icon------
        self.image_icon=PhotoImage(file=os.path.join("Images","imagelogo.png"))
        self.imagelogo=self.image_icon.subsample(7,7)

        self.audio_icon=PhotoImage(file=os.path.join("Images","oaudiologo.png"))
        self.audiologo=self.audio_icon.subsample(3,3)

        self.video_icon=PhotoImage(file=os.path.join("Images","ovideologo.png"))
        self.videologo=self.video_icon.subsample(4,4)

        self.doc_icon=PhotoImage(file=os.path.join("Images","doclogo.png"))
        self.doclogo=self.doc_icon.subsample(3,3)

        self.other_icon=PhotoImage(file=os.path.join("Images","otherlogo.png"))
    ...
    def Total_count(self):
        ...
        # Build a combined list of all supported extensions for "others" computation
        combine_list=[]
        for extensions in self.folders.values():
            combine_list.extend(extensions)

        for file_name in self.all_files:
            if os.path.isfile(os.path.join(self.directry,file_name)):
                self.count+=1
                ...
                if ext in self.folders["images"]:
                    images+=1
                elif ext in self.folders["audio"]:
                    audios+=1
